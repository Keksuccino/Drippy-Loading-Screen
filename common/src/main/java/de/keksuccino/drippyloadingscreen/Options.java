...
public class Options extends AbstractOptions {
    ...
    public final Option<Integer> earlyLoadingLogoWidth = new Option<>(config, "early_loading_logo_width", 480, "early_loading");
    public final Option<Integer> earlyLoadingLogoHeight = new Option<>(config, "early_loading_logo_height", 120, "early_loading");
