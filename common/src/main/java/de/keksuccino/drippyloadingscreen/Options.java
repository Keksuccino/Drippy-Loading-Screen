...
public class Options extends AbstractOptions {
    ...
    public final Option<String> earlyLoadingBarProgressTexturePath = new Option<>(config, "early_loading_bar_progress_texture_path", "/config/fancymenu/assets/some_bar_progress_image.png", "early_loading"); // only supports PNG; bar falls back to Vanilla-like dynamically rendered progress if image not found
