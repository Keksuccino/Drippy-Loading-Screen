...
public abstract class CustomizationItemContainer {
    ...
    public CustomizationItemContainer(@NotNull String uniqueItemIdentifier) {
    ...
    /**
     * Returns a new instance of the {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} of this item.<br>
     * This {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} allows the user to customize the item in the editor and
     * will serialize the item to a {@link PropertiesSection} when the layout gets saved.<br><br>
     *
     * The {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} returned here should be an element specifically made for the type of this item.<br>
     * You need to add some things to the element, so it can handle the item correctly.
     *
     * @param item The item instance that needs to be set to the {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} that will be returned by this method.
     * @param handler The layout editor instance that will handle the element. Needs to be set to the {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} that will be returned by this method.
     * @return A new {@link de.keksuccino.fancymenu.api.item.LayoutEditorElement} instance.
     */
