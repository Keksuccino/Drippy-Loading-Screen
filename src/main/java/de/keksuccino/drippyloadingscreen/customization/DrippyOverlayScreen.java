...
public class DrippyOverlayScreen extends Screen {
    ...
    private static Button.IPressable configButtonOnPress = (press) -> {
    ...
    public void renderDirtBackground(int i) {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new GuiScreenEvent.BackgroundDrawnEvent(this, new MatrixStack()));
    }
