			...
			if (this.parent.isObjectFocused()) {
				...
				AdvancedButton stretchXBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("drippyloadingscreen.helper.creator.object.stretch.x"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedX) {
						press.setMessage(Component.literal(Locals.localize("drippyloadingscreen.helper.creator.object.stretch.x")));
					} else {
						press.setMessage(Component.literal("§a" + Locals.localize("drippyloadingscreen.helper.creator.object.stretch.x")));
					}
				...
				AdvancedButton stretchYBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("drippyloadingscreen.helper.creator.object.stretch.y"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedY) {
						press.setMessage(Component.literal(Locals.localize("drippyloadingscreen.helper.creator.object.stretch.y")));
					} else {
						press.setMessage(Component.literal("§a" + Locals.localize("drippyloadingscreen.helper.creator.object.stretch.y")));
					}
