...
public class AutoScalingPopup extends FHPopup {
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
        ...
        drawCenteredString(matrix, font, Locals.localize("drippyloadingscreen.helper.editor.windowsize.currentwidth") + ": " + Minecraft.getInstance().getMainWindow().getWidth(), screenCenterX, screenCenterY + 45, -1);
        drawCenteredString(matrix, font, Locals.localize("drippyloadingscreen.helper.editor.windowsize.currentheight") + ": " + Minecraft.getInstance().getMainWindow().getHeight(), screenCenterX, screenCenterY + 55, -1);
