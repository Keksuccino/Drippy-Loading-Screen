...
public class LayoutEditorScreen extends Screen {
	...
	protected void renderEditorBackground(MatrixStack matrix) {
		...
		if (this.splashLayer.backgroundImage != null) {
			Minecraft.getInstance().getTextureManager().bind(this.splashLayer.backgroundImage);
			RenderSystem.enableBlend();
			...
			if (!this.splashLayer.keepBackgroundAspectRatio) {
				...
				if (this.splashLayer.backgroundImageSource != null) {
					...
					System.out.println("IMAGE SOURCE NULL IN EDITOR");
				}
			}
