...
public class OverlayProgressBarLayoutElement extends DeepCustomizationLayoutEditorElement {
    ...
    public OverlayProgressBarLayoutElement(DeepCustomizationElement parentDeepCustomizationElement, DeepCustomizationItem customizationItemInstance, LayoutEditorScreen handler) {
