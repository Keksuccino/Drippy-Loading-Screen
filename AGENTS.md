...
- This workspace gives you access to the actual Drippy Loading Screen source workspaces for multiple branches/Minecraft versions.
- The folder name of these should always be something like `drippyloadingscreen-0.0.0`, with the `0.0.0` replaced with the Minecraft version the workspace is targeting.
...
## Minecraft Sources
- You have access to full sources of Minecraft, and even some libraries used by Minecraft and Drippy Loading Screen, in `/Volumes/STUFF/CODING/WORKSPACES/Java/Minecraft Mods/.MINECRAFT_SOURCES`.
...
- Sources for some libraries used by Minecraft and Drippy Loading Screen are in `/Volumes/STUFF/CODING/WORKSPACES/Java/Minecraft Mods/.MINECRAFT_SOURCES/<minecraft_version>/libraries/`.
